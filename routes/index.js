...
function get_all_photos(req, res) {
...
function write_to_gridfs(req, res, db, fileId, photo_url) {
...
function cache_all_photos(req, res, sql_results) {
    ...
    MongoClient.connect('mongodb://CIS550:databaseproject@dharma.mongohq.com:10042/Pennterest-Trial', function(err, db) {
        ...
        for (var i = 2; i < 3; i++) {
            ...
            write_to_gridfs(req, res, db, sql_results[i]["PHOTOID"] + ".txt", sql_results[i]["URL"] )
        } 
